...
// If your Input component exists elsewhere, update the path accordingly, for example:
import { Input } from "@/components/ui/input";
// Or, if you need to create the file, create 'src/components/ui/input.tsx' with your Input component.
        ...
        <Tabs defaultValue="posts" className="w-full">
          ...
          <TabsContent value="posts" className="mt-6">
            <div className="space-y-6">
              {posts.length > 0 ? (
                posts.map((post) => <PostCard key={post.id} post={post} getDbUserId={user.id} />)
              ) : (
          ...
          <TabsContent value="likes" className="mt-6">
            <div className="space-y-6">
              {likedPosts.length > 0 ? (
                likedPosts.map((post) => <PostCard key={post.id} post={post} getDbUserId={user.id} />)
              ) : (
